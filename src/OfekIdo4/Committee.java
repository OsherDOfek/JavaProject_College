...
public class Committee<T extends Lecturer> implements Cloneable{
    ...
    public Committee(String name, Lecturer head_of_com) throws InvalidDegreeException, CommitteeAlreadyExistsException {
    ...
    public void add_com_mem(T l) throws AlreadyCommitteeMemberException, InvalidDegreeException, CommitteeAlreadyExistsException {
        ...
        if (l.getLevel() != this.members.get(0).getLevel())
            throw new InvalidDegreeException();
	...
	public void update_head(Lecturer lec) throws InvalidDegreeException, CommitteeDoesntExistsException, CommitteeAlreadyExistsException {
	...
	public Committee<T> duplicate() throws InvalidDegreeException, AlreadyCommitteeMemberException, CommitteeAlreadyExistsException {
    ...
    public void setHead_of_com(Lecturer head_of_com) throws InvalidDegreeException, CommitteeDoesntExistsException, CommitteeAlreadyExistsException {
        if (head_of_com == null) {
            return;
        }
        try {
			update_head(head_of_com);
		} catch (InvalidDegreeException | CommitteeDoesntExistsException | CommitteeAlreadyExistsException e) {
